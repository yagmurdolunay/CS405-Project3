...
void main()
{
    ...
    // Debug: Işık yönü görüntüleme
    vec3 debugLightDir = lightdir * 0.5 + 0.5; // [-1,1] -> [0,1]
    float debugDiff = max(dot(normal, lightdir), 0.0);
    ...
    if (isLightSource) {
        ...
        gl_FragColor = vec4(vec3(debugDiff), 1.0); // Diffuse değerini görüntüle
    }
}
`;
