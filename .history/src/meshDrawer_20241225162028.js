...
void main()
{
	...
	// Diffuse - daha güçlü bir etki
	diff = max(dot(normal, lightdir), 0.0) * 1.5;

	// Specular - daha keskin ve parlak
	vec3 viewDir = normalize(vec3(0.0, 0.0, 5.0) - fragPos); // Kamera pozisyonundan fragment'a
